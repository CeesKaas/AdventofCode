...
public class CodeUnderTest
{
    ...
    [Benchmark]
    public void packetWithList()
    {

        FindIndexOfAfterMarker1("mjqjpqmgbljsphdztnvjfqwrcgsmlb", 4);

    }
    [Benchmark]
    public void PacketWithRange()
    {
        FindIndexOfAfterMarker("mjqjpqmgbljsphdztnvjfqwrcgsmlb", 4);
    }
}