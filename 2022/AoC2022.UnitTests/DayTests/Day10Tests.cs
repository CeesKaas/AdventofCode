...
internal class Day10Tests
{
    ...
    public async Task TestDay10Part1()
    {
        ...
        Assert.That(await objUnderTest.Part1(), Is.EqualTo(13140));
    }
    [Test]
    public async Task TestDay10Part2()
    {
        var inputMock = PrepareInput();
        var objUnderTest = new Day10(inputMock.Object);
        await objUnderTest.Part1();
        Assert.That((await objUnderTest.Part2()).Replace('█','#').Replace(' ', '.').Trim(), Is.EqualTo(@"##..##..##..##..##..##..##..##..##..##..
###...###...###...###...###...###...###.
####....####....####....####....####....
#####.....#####.....#####.....#####.....
######......######......######......####
#######.......#######.......#######....."));
    ...
    private static Mock<InputFetcher> PrepareInput()
    {
        ...
        inputMock.Setup(m => m.FetchInputAsString(It.IsAny<int>())).Returns(Task.FromResult(@"addx 15
addx -11
addx 6
addx -3
addx 5
