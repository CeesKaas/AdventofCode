...
namespace Day9
{
    public class Computer
    {
        ...
        private BlockingCollection<long> _inputs;

        public BlockingCollection<long> Inputs
        {
            get
            {
                if (_inputs == null)
                {
                    _inputs = new BlockingCollection<long>();
                }
                return _inputs;
            }
            set => _inputs = value;
        }
        public BlockingCollection<long> Outputs { get; } = new BlockingCollection<long>();
                ...
                while (true)
                {
                    ...
                    switch (opcode)
                    {
                        ...
                        case 2: // Multiplication
                            ...
                            break;
                        case 3: // Read
                            SetParameterValue(ReadInput(), parameter1, parameterMode1);
                            break;
                        case 4: // Write
                            WriteOutput(GetParameterValue(parameter1, parameterMode1));
                            break;
                        case 5: // Jump if true
                            if (parameter1 != 0)
                            {
